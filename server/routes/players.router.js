...
router.get('/', (req, res) => {
    ...
    const queryText = `SELECT "p".id, "p".player_name, "p".character_name, "p". character_img, "p".character_level, "p".current_hp, "p".total_hp, "p".armor_class, "p".speed, "p".initiative_bonus, "p".strength, "p".str_bonus, "p".str_save, "p".dexterity, "p".dex_bonus, "p".dex_save, "p".constitution, "p".con_bonus, "p".con_save, "p".intelligence, "p".int_bonus, "p".int_save, "p".wisdom, "p".wis_bonus, "p".wis_save, "p".charisma, "p".cha_bonus, "p".cha_save, "p".displayed, JSON_AGG (json_build_object('id', "pi".id, 'quantity',"pi".quantity, 'item_name', "i".item_name)) AS quantity_items, JSON_AGG (json_build_object ('id', "pc".id,'length', "pc".condition_length, 'condition_name', "c".condition_name)) AS length_condition, "g".game_name, "g".dm_id FROM "players" AS "p"
    ...
    WHERE "g".dm_id = $1
    GROUP BY "p".id, "g".game_name, "g".dm_id;
    `;
