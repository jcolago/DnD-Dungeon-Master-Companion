                ...
                <FormControl>
                    <form  onSubmit={addNewStatsInfo}>
                        ...
                        <InputLabel style={{margin: "5px"}} htmlFor="str-bonus">Strength Bonus</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Strength Bonus" id="str-bonus" type="number" placeholder="Strength Bonus" value={newPlayerStats.str_bonus} onChange={handleStrBonusChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}} htmlFor="str-save">Strength Saving Throw</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Strength Saving Throw" id="str-save"  type="number" placeholder="Strength Save" value={newPlayerStats.str_save} onChange={handleStrSaveChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}}htmlFor="dexterity">Dexterity</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Dexterity" id="dexterity"  type="number" placeholder="Dexterity" value={newPlayerStats.dexterity} onChange={handleDexterityChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}}htmlFor="dex-bonus">Dexterity Bonus</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Dexterty Bonus" id="dex-bonus"  type="number" placeholder="Dexterity Bonus" value={newPlayerStats.dex_bonus} onChange={handleDexBonusChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}}htmlFor="dex-save">Dexterity Saving Throw</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Dexterity Saving Throw" id="dex-save"  type="number" placeholder="Dexterity Save" value={newPlayerStats.dex_save} onChange={handleDexSaveChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}}htmlFor="constitution">Constitution</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}}
                        ...
                        <InputLabel style={{margin: "5px"}}htmlFor="con-bonus">Constitution Bonus</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Constitution Bonus" id="con-bonus"  type="number" placeholder="Constitution Bonus" value={newPlayerStats.con_bonus} onChange={handleConBonusChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}}htmlFor="con-save">Constitution Saving Throw</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Constitution Saving Throw" id="con-save"  type="number" placeholder="Constitution Save" value={newPlayerStats.con_save} onChange={handleConSaveChange} />
                        </FormControl>
                        <FormControl>
                        ...
                        <InputLabel style={{margin: "5px"}}htmlFor="int-bonus">Intelligence Bonus</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}}  label="Intelligence Bonus" id="int-bonus"  type="number" placeholder="Intelligence Bonus" value={newPlayerStats.int_bonus} onChange={handleIntBonusChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}} htmlFor="int-save">Intelligence Saving Throw</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Intelligence Saving Throw" id="ing-save"  type="number" placeholder="Intelligence Save" value={newPlayerStats.int_save} onChange={handleIntSaveChange} />
                        </FormControl>
                        <FormControl>
                        ...
                        <InputLabel style={{margin: "5px"}}htmlFor="wis-bonus">Wisdom Bonus</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Wisdom Bonus" id="wis-bonus"  type="number" placeholder="Wisdom Bonus" value={newPlayerStats.wis_bonus} onChange={handleWisBonusChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}}htmlFor="wis-save">Wisdom Saving Throw</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Wisdom Saving Throw" id="wis-save"  type="number" placeholder="Wisdom Save" value={newPlayerStats.wis_save} onChange={handleWisSaveChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}}htmlFor="charisma">Charisma</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Charisma" id="charisma"  type="number" placeholder="Charisma" value={newPlayerStats.charisma} onChange={handleCharismaChange} />
                        </FormControl>
                        <FormControl>
                        <InputLabel style={{margin: "5px"}}htmlFor="cha-bonus">Charisma Bonus</InputLabel>
                            <OutlinedInput style={{margin: "5px", width: "225px"}} label="Charisma Bonus" id="cha-bonus"  type="number" placeholder="Charisma Bonus" value={newPlayerStats.cha_bonus} onChange={handleChaBonusChange} />
                        </FormControl>
                        <FormControl>
